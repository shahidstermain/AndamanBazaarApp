...
} from "../../src/components/PriceDiscoveryWidget";
...
const mockSuggestion: PriceSuggestion = {
  ...
  ai_analysis:
    "Based on 18 similar listings, consider pricing at ₹15,000 for a quick sale.",
};
...
describe("PriceDiscoveryWidget", () => {
  ...
  it('shows "above avg" text when price is significantly higher', () => {
    ...
    expect(
      screen.getByText(/higher than similar listings/i),
    ).toBeInTheDocument();
  });
});
