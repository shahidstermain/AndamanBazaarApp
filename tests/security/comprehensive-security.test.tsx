...
describe("Security Tests", () => {
  ...
  describe("Input Sanitization", () => {
    ...
    it("should prevent HTML injection in listing descriptions", () => {
      const maliciousDescription =
        "<script>stealData()</script><p>Valid description</p>";
  ...
  describe("Authorization and Access Control", () => {
    it("should prevent users from accessing other users data", () => {
      ...
      expect(
        canAccessResource({ ...currentUser, role: "admin" }, resourceOwner),
      ).toBe(true);
    });
    ...
    it("should prevent injection attacks in search queries", () => {
      ...
      const sanitizeQuery = (query: string) => {
        return query
          ...
          .replace(/--/g, "")
          .replace(
            /\b(DROP|TABLE|DELETE|INSERT|UPDATE|UNION|SELECT|ALTER|CREATE|TRUNCATE)\b/gi,
            "",
          )
          .trim();
      };
  ...
  describe("API Security", () => {
    ...
    it("should implement proper CORS policies", () => {
      const allowedOrigins = [
        "https://andamanbazaar.com",
        "https://www.andamanbazaar.com",
      ];
