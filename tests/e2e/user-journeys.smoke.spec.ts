...
test.describe('User journeys smoke (blocking)', () => {
  test('unauthenticated user trying /admin gets redirected away', async ({ page }) => {
  ...
  test('existing user can search from home and reach listings page', async ({ page }) => {
  ...
  test('profile page loads and delete action path is reachable for owner listings', async ({ page }) => {
