...
export const createPayment = (overrides = {}) => ({
  ...
  currency: 'INR',
  status: faker.helpers.arrayElement(['pending', 'processing', 'completed', 'failed', 'refunded']),
  paymentMethod: faker.helpers.arrayElement(['upi', 'card', 'net_banking', 'cash']),
...
export const createNotification = (overrides = {}) => ({
  ...
  type: faker.helpers.arrayElement([
    'new_message', 'listing_view', 'listing_sold', 'payment_received',
...
export const createBulkMessages = (count: number, chatId: string, overrides = {}) => 
