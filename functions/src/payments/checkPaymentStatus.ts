 ...
 */
export const checkPaymentStatus = paymentsRuntime.https.onCall(
  async (data: CheckPaymentStatusRequest, context) => {
    ...
    try {
      ...
      const updatedPaymentDoc = await admin
        .firestore()
        .collection("payments")
        .doc(orderId)
        .get();
 ...
 */
export const getPaymentHistory = paymentsRuntime.https.onCall(
 ...
 */
export const getPaymentDetails = paymentsRuntime.https.onCall(
