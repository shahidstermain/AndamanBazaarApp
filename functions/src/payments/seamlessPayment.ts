 ...
 */
export const createSeamlessOrder = paymentsRuntime.https.onCall(
  async (data, context) => {
    ...
    try {
      ...
      logger.info("Payment order stored and listing reserved", {
        orderId,
        listingId,
      });
 ...
 */
export const processSeamlessPayment = paymentsRuntime.https.onCall(
  async (data, context) => {
    if (!context.auth) {
      throw new functions.https.HttpsError(
        "unauthenticated",
 ...
 */
export const getOrderPayments = paymentsRuntime.https.onCall(
  async (data, context) => {
    if (!context.auth) {
      throw new functions.https.HttpsError(
        "unauthenticated",
 ...
 */
export const verifyOrderStatus = paymentsRuntime.https.onCall(
  async (data, context) => {
    if (!context.auth) {
      throw new functions.https.HttpsError(
        "unauthenticated",
