...
exports.sendWeeklyTrendingEmails = functions
  .runWith({ secrets: ["EMAIL_API_KEY"] })
  ...
  .onRun(async () => {
    try {
      ...
      for (const userDoc of usersSnap.docs) {
        ...
        const { emailTemplates: tmpl } = await Promise.resolve().then(() =>
          __importStar(require("./emailTemplatesNode")),
        );
