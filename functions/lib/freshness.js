...
exports.calculateResponseRates = exports.markInactiveListings = exports.updateListingFreshness = void 0;
const functions = __importStar(require("firebase-functions"));
const admin = __importStar(require("firebase-admin"));
// Update listing freshness when seller is active (posts, replies, etc.)
exports.updateListingFreshness = functions.https.onCall(async (data, context) => {
    if (!context.auth?.uid) {
