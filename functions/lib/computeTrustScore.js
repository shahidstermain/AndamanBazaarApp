...
exports.computeTrustScore = void 0;
 ...
 */
exports.computeTrustScore = (0, https_1.onCall)(async (request) => {
    const { operatorId } = request.data;
    if (!operatorId || typeof operatorId !== 'string') {
        throw new https_1.HttpsError('invalid-argument', 'The function must be called with an operatorId.');
    }
    ...
    try {
        ...
        let badge = 'Low';
        if (finalScore >= 85 && operatorTier === 'premium')
            badge = 'Premium';
        else if (finalScore >= 60 && operatorTier === 'verified')
            badge = 'Trusted';
        ...
        throw new https_1.HttpsError('internal', 'Unable to compute trust score.');
    }
});
//# sourceMappingURL=computeTrustScore.js.map