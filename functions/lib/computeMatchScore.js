...
exports.computeMatchScore = (0, https_1.onCall)(async (request) => {
    // Input Validation
    if (!request.auth) {
        throw new https_1.HttpsError("unauthenticated", "User must be authenticated to compute personalized scores.");
    }
    if (!request.data.activityId || !request.data.price) {
        throw new https_1.HttpsError("invalid-argument", "Activity ID and basic attributes are required.");
    }
    try {
