          ...
          <div className="p-8 md:p-16 space-y-12">
            <section className="space-y-4">
              ...
              <p className="text-warm-600 font-medium leading-relaxed text-lg">
                AndamanBazaar is a platform built on trust. This policy explains
                what information we collect, how we use it, and how we protect
                it. Our goal is to be transparent and to keep your data safe
                while you use our marketplace for the Andaman & Nicobar Islands.
              </p>
            </section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="p-8 bg-warm-50 rounded-3xl space-y-3 border border-warm-200">
                  ...
                  <p className="text-warm-600 font-bold leading-relaxed text-base">
                    To create your account, we ask for your name, email, and
                    optional phone number. This helps other users know who they
                    are trading with.
                  </p>
                </div>
                <div className="p-8 bg-warm-50 rounded-3xl space-y-3 border border-warm-200">
                  ...
                  <p className="text-warm-600 font-bold leading-relaxed text-base">
                    We use your device's GPS to confirm you are on the islands.
                    This is for the 'Verified Resident' badge, which builds
                    trust in our local community.
                  </p>
                </div>
              </div>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p className="text-warm-600 font-medium leading-relaxed text-lg">
                Your data is stored securely on Google Cloud through Firebase
                services, including Firebase Authentication, Cloud Firestore,
                and Firebase Storage. All communication is encrypted with
                SSL/TLS, and access is enforced through authenticated
                server-side and security-rule checks.
              </p>
            </section>
            ...
            <section className="space-y-4">
              ...
              <p className="text-warm-600 font-medium leading-relaxed text-lg">
                We comply with Indian IT laws. While we use global
                infrastructure for reliability, our services and data management
                are focused exclusively on users within the Andaman & Nicobar
                Islands, under Indian jurisdiction.
              </p>
            </section>
            ...
            <div className="pt-12 border-t border-warm-200 flex flex-col items-center gap-4 text-center">
              ...
              <a
                href="mailto:privacy@andamanbazaar.com"
