    ...
    <div className="min-h-screen bg-warm-50">
      ...
      <div className="bg-white rounded-3xl shadow-2xl border border-warm-200 overflow-hidden">
        <div className="bg-teal-gradient p-12 text-white relative overflow-hidden">
          ...
          <p className="mt-4 text-white/90 font-bold text-base uppercase tracking-widest">Legal Framework for Our Island Community</p>
        </div>
        ...
        <div className="p-8 md:p-16 space-y-12">
          <section className="space-y-4">
            <div className="flex items-center gap-4">
              ...
              <h2 className="text-3xl font-black text-midnight-700 uppercase tracking-tight">1. Our Agreement</h2>
            </div>
          ...
          <section className="space-y-4">
            <div className="flex items-center space-x-4">
              ...
              <h2 className="text-3xl font-black text-midnight-700 uppercase tracking-tight">3. Community Rules</h2>
            </div>
            <ul className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4 pt-4">
              {[
                ...
                <li key={i} className="flex items-start space-x-3 text-lg font-bold text-warm-600">
          ...
          <section className="space-y-4">
            <div className="flex items-center space-x-4">
              ...
              <h2 className="text-3xl font-black text-midnight-700 uppercase tracking-tight">4. Our Role and Limitations</h2>
            </div>
            <p className="text-warm-600 font-medium leading-relaxed text-lg">
          ...
          <div className="pt-8 border-t border-warm-200 text-center">
            <p className="text-sm font-black text-warm-400 uppercase tracking-widest">Last Updated: August 2024</p>
          </div>
        </div>
      </div>
    </div>
