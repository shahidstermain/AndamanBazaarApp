    ...
    return (
      <div className="min-h-screen bg-warm-50 flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-bold text-midnight-800 mb-2">Seller Not Found</h2>
          <p className="text-warm-600 mb-4">This seller profile doesn't exist or has been removed.</p>
          ...
          <div className="flex flex-col md:flex-row gap-6">
            ...
            <div className="flex-1">
              <div className="flex flex-wrap items-center gap-3 mb-3">
                <h1 className="text-2xl font-bold text-midnight-800">{seller.full_name}</h1>
            ...
            <div className="flex-shrink-0">
              <div className="bg-warm-50 rounded-xl p-4 space-y-3">
                <div className="text-center">
                  <div className="text-2xl font-bold text-midnight-800">{seller.stats.total_listings}</div>
                  <div className="text-xs text-warm-600 uppercase tracking-wider">Total Listings</div>
                </div>
                <div className="flex gap-4 text-center">
                  <div>
                    <div className="text-lg font-bold text-teal-600">{seller.stats.active_listings}</div>
                    <div className="text-xs text-warm-600">Active</div>
                  </div>
                  <div>
                    <div className="text-lg font-bold text-coral-500">{seller.stats.sold_listings}</div>
