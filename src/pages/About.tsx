            ...
            <div className="app-container py-12 animate-slide-up">
                ...
                {/* Header */}
                    <div className="bg-teal-gradient p-12 text-white relative overflow-hidden">
                        ...
                        <p className="mt-4 text-white/90 font-bold text-base uppercase tracking-widest">Who We Are</p>
                </div>
                ...
                <div className="p-8 md:p-16 space-y-12">
                    ...
                    <section className="space-y-4">
                        <div className="flex items-center gap-4">
                            ...
                            <h2 className="text-3xl font-black text-midnight-700 uppercase tracking-tight">Our Platform</h2>
                        </div>
                    ...
                    <section className="space-y-4">
                        <div className="flex items-center gap-4">
                            ...
                            <h2 className="text-3xl font-black text-midnight-700 uppercase tracking-tight">The Builder</h2>
                        </div>
                        <div className="p-8 bg-warm-50 rounded-3xl border border-warm-200">
                            <div className="flex items-start gap-5">
                                ...
                                <div className="space-y-3 flex-1">
                                    <div>
                                        <p className="text-xl font-black text-midnight-700">SHAHID MOOSA</p>
                                    ...
                                    <div className="flex flex-wrap gap-4 pt-2">
                                        <div>
                                            ...
                                            <p className="text-sm font-black text-midnight-700 mt-0.5">AndamanBazaar</p>
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            <p className="text-sm font-black text-midnight-700 mt-0.5">Andaman Islands 🏝️</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <section className="space-y-4">
                        <div className="flex items-center gap-4">
                            ...
                            <h2 className="text-3xl font-black text-midnight-700 uppercase tracking-tight">Our Location</h2>
                        </div>
                        <p className="text-warm-600 font-medium leading-relaxed text-lg">
                    ...
                    {/* Services Overview */}
                    <section className="space-y-4">
                        <h2 className="text-3xl font-black text-midnight-700 uppercase tracking-tight">What We Offer</h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="p-8 bg-warm-50 rounded-3xl space-y-3 border border-warm-200">
                                <h3 className="font-black text-midnight-700 uppercase text-lg">Free Listings</h3>
                            ...
                            <div className="p-8 bg-warm-50 rounded-3xl space-y-3 border border-warm-200">
                                <h3 className="font-black text-midnight-700 uppercase text-lg">Listing Boosts</h3>
                                <p className="text-warm-600 font-bold leading-relaxed text-base">
                                    Promote your listings with paid boost tiers for enhanced visibility. See our{' '}
                                    <Link to="/pricing" className="text-teal-600 underline hover:text-teal-700 transition-colors">
                                        Pricing page
                                    </Link>{' '}
                                    for details.
                                </p>
                    ...
                    <div className="pt-12 border-t border-warm-200 flex flex-col items-center gap-4 text-center">
                        <p className="text-warm-600 text-lg font-bold uppercase tracking-widest">Have questions?</p>
                        <Link
                            to="/contact"
