...
const FAQItem = ({ faq }: { faq: (typeof FAQS)[0] }) => {
  ...
  return (
    <div className="group bg-white/80 backdrop-blur-sm rounded-3xl border border-warm-200 p-8 hover:border-teal-300 transition-all duration-300">
      ...
      >
        <h4 className="text-lg font-black text-midnight-700 uppercase tracking-tight">
          {faq.q}
        </h4>
        <ChevronDown
          className={`text-warm-400 group-hover:text-teal-500 transition-all duration-300 ${isOpen ? "rotate-180" : ""}`}
        />
      </div>
      {isOpen && (
    ...
    <div className="min-h-screen bg-mesh font-sans selection:bg-teal-100 selection:text-teal-900 overflow-x-hidden">
      ...
      <header className="max-w-7xl mx-auto px-6 pt-16 pb-24 relative">
        ...
        <div className="max-w-4xl space-y-6">
          <div className="inline-flex items-center gap-2 bg-coral-50 px-4 py-1.5 rounded-full border border-coral-100/50 shadow-sm animate-fade-in">
            ...
            <span className="text-[10px] font-black uppercase tracking-widest text-coral-600">
          ...
          <p className="text-lg md:text-xl text-midnight-500 font-medium leading-relaxed max-w-2xl reveal-delay-2">
            Featured listings on AndamanBazaar get{" "}
            <strong className="text-midnight-700">10x more visibility</strong>{" "}
            from verified local buyers. Reach more people, faster.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {BENEFITS.map((benefit, idx) => {
              ...
              return (
                <div
                  key={idx}
                  className="glass p-8 rounded-3xl space-y-4 hover:scale-[1.02] transition-transform duration-500"
                >
                  <div
                    className={`w-14 h-14 ${benefit.bg} ${benefit.color} rounded-2xl flex items-center justify-center`}
                  >
                    <Icon size={28} />
                  </div>
                  <h3 className="text-2xl font-black text-midnight-700 uppercase tracking-tight">
                    {benefit.title}
                  </h3>
                  <p className="text-midnight-500 font-medium leading-relaxed">
                    {benefit.desc}
                  </p>
                </div>
              );
      ...
      <section id="plans" className="max-w-7xl mx-auto px-6 py-32 space-y-16">
        <div className="text-center max-w-2xl mx-auto space-y-4">
          <h2 className="text-4xl md:text-6xl font-black text-midnight-700 uppercase tracking-tighter">
            Scale Your Sale
          </h2>
              ...
              >
                ...
                <div className="p-10 space-y-8 flex-1">
                  <div className="space-y-4">
                    <div
                      className={`w-16 h-16 ${ui.bgColor} ${ui.color} rounded-2xl flex items-center justify-center shadow-inner`}
                    >
                      <Icon size={32} />
                    </div>
                    <div>
                      <h3 className="text-3xl font-black text-midnight-700 uppercase tracking-tight">
                        {tier.name}
                      </h3>
                      <p className="text-midnight-400 font-bold uppercase text-[10px] tracking-widest">
                        {tier.durationLabel} Visibility
                      </p>
                    </div>
                  </div>

                  <div className="flex items-baseline gap-1">
                    <span className={`text-6xl font-black text-midnight-700`}>
                      ₹{tier.priceInr}
                    </span>
                    <span className="text-midnight-400 font-bold text-sm tracking-wide">
                      INR
                    </span>
                  </div>
                  ...
                  <ul className="space-y-4 pt-4">
                    {tier.features.map((feature, i) => (
                      <li key={i} className="flex items-start gap-3 group">
                        <div
                          className={`w-5 h-5 rounded-full ${ui.bgColor} ${ui.color} flex items-center justify-center flex-shrink-0 mt-0.5 group-hover:scale-110 transition-transform`}
                        >
                          <CheckCircle size={12} strokeWidth={3} />
                        </div>
                        <span className="text-midnight-600 font-medium text-sm leading-tight">
                          {feature}
                        </span>
                      </li>
                    ))}
                ...
                <div className="p-8 pt-0">
                  <Link
                    to="/dashboard"
                    className={`w-full py-5 rounded-[24px] font-black uppercase tracking-widest text-sm text-center transition-all duration-300 shadow-lg ${
                      tier.popular
        ...
        <div className="glass p-8 rounded-3xl flex flex-col md:flex-row items-center justify-between gap-6 border-white/40">
          <div className="flex items-center gap-6">
            ...
            <div>
              <h4 className="text-xl font-black text-midnight-700 uppercase tracking-tight">
                Standard Listing
              </h4>
              <p className="text-midnight-500 font-medium">
                No boost, valid for 30 days. Perfect for casual sellers.
              </p>
            </div>
          </div>
          <div className="flex items-center gap-3 text-right">
            <span className="text-3xl font-black text-midnight-700 block">
              ₹0
            </span>
            <span className="text-midnight-400 font-bold uppercase text-xs tracking-widest">
              Always Free
            </span>
          </div>
        </div>
          ...
          <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8 text-center lg:text-left">
              ...
              <div className="pt-4">
                <Link
                  to="/listings"
                  className="btn-primary scale-125 origin-center lg:origin-left"
                >
                  Start Selling Now
                </Link>
              </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="glass-dark p-8 rounded-3xl space-y-2">
                ...
                <span className="text-[10px] font-black uppercase tracking-[0.2rem] opacity-70 mt-2 block">
                  Islanders Only
                </span>
              </div>
              <div className="glass-dark p-8 rounded-3xl space-y-2">
              ...
              <div className="glass-dark p-8 rounded-3xl space-y-2 col-span-2">
                ...
                <p className="text-xs font-medium opacity-80 leading-relaxed">
                  We verify every payment and moderate all listings to ensure
                  you have a safe island experience.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="bg-warm-100/30 py-32">
        <div className="max-w-4xl mx-auto px-6 space-y-12">
          <div className="text-center space-y-4">
            <h2 className="text-3xl md:text-5xl font-black text-midnight-700 uppercase tracking-tighter">
              Common Questions
            </h2>
            <p className="text-midnight-500 font-bold uppercase tracking-widest text-xs">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              />
              <span className="text-2xl font-black tracking-tighter text-midnight-700">
                AndamanBazaar.
              </span>
            </div>
            <p className="text-midnight-400 text-sm font-medium leading-relaxed max-w-sm">
              Buy & Sell locally in Andaman — no mainland scams. Built with love
              in Port Blair.
            </p>
          </div>
          ...
          <div className="space-y-6 md:text-right">
            <div className="flex flex-wrap md:justify-end gap-x-8 gap-y-3 font-black uppercase text-[10px] tracking-widest text-midnight-500">
              ...
              <a href="/terms" className="hover:text-ocean transition-colors">
                Terms
              </a>
              <a href="/privacy" className="hover:text-ocean transition-colors">
                Privacy
              </a>
            </div>
