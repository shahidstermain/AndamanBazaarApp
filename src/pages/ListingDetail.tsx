...
export const ListingDetail: React.FC = () => {
  ...
  const fbText = listing
    ? COPY.SHARING.FB_GROUP_TEMPLATE(
        listing.title,
        listing.price,
        listing.city,
        shareLink,
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-white rounded-3xl p-6 md:p-8 space-y-6 shadow-sm border border-warm-200">
                <div className="space-y-4">
                  <div className="flex flex-wrap items-center gap-2">
                    {listing.is_official && (
                      <TrustBadge level="official" size="md" />
                    )}
                  ...
                  <div className="flex justify-between items-start gap-4">
                    <div className="flex flex-col gap-2">
                      ...
                      {(listing as any).isBoosted &&
                        (listing as any).boostTier && (
                          <div>
                            <BoostBadge
                              tier={(listing as any).boostTier}
                              size="md"
                            />
                          </div>
                        )}
              ...
              <div className="bg-white rounded-3xl p-6 md:p-8 space-y-6 shadow-sm border border-warm-200">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-lg font-black text-midnight-700 uppercase tracking-tight">
                      Share Locally
                    </h3>
                    <p className="text-xs font-bold text-warm-400 uppercase tracking-widest">
                      Post this deal to your groups
                    </p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  <div className="p-5 rounded-2xl bg-emerald-50 border border-emerald-100 space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <button
                        onClick={() =>
                          copyToClipboard(whatsappText, "WhatsApp template")
                        }
                    ...
                    <p className="text-[11px] text-emerald-800/70 font-medium leading-relaxed italic">
                      Send to your friends or travel group instantly via
                      WhatsApp.
                    </p>
            ...
            <div className="space-y-6">
              ...
              {seller && (
                <div className="bg-white rounded-3xl p-6 shadow-sm border border-warm-200">
                  <h3 className="text-lg font-bold text-midnight-700 mb-3 px-1">
                    Meet the Seller
                  </h3>
