...
export const COPY = {
  TOAST: {
    ...
    LISTING_DELETED: 'Listing hata di — barge maal ki tarah gone 🚢',
  ...
  EMPTY_STATE: {
    NO_LISTINGS: 'Kuch nahi mila… barge late tha shayad. Try another category?',
  ...
  LOADING: {
    HOME_FEED: 'Freshly landed — like barge maal, but faster 🚢',
    AUTH: 'Verify ho raha hai... BSNL se toh fast hai yeh 😂',
    PULL_REFRESH: 'Sea calm hai, listings aa rahe hain… 🌊',
  },

  SUCCESS: {
    LISTING_PUBLISHED: 'Listing live ho gayi! Ab wait karo... faster than a BSNL connection ⚡',
    BOOST_ACTIVATED: 'Boost active! Teri listing ab barge se pehle pahunchegi 🚀',
    SETTINGS_SAVED: 'Saved! Faster than Sunday Aberdeen Bazaar se nikal paana ✅',
  },

  HOME: {
    HERO_SUBTITLE: 'Freshly landed — like barge maal, but faster 🚢',
  },

  CREATE_LISTING: {
    PHOTO_HINT: 'Ek achi photo lagao — tourists bhi dekhte hain yaar 📸',
    PRICE_PLACEHOLDER: 'Andaman price — barge charges include karna mat bhoolna 😉',
  ...
  BOOST: {
    ...
    TIER_99: '₹99 mein Corbyn\'s Cove jitni visibility — locals dekhenge zaroor 🌊',
  ...
  ADMIN: {
    DASHBOARD_GREETING: 'Welcome back, Admin. Sab theek hai — barge bhi time pe aaya aaj 🎉',
