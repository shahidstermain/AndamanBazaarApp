    ...
    >
      ...
      <div className="grid grid-cols-3 gap-4 mb-4">
        ...
        <div className="text-center">
          ...
          <p className="text-xs text-gray-500">
            {analytics.chat_conversion_rate}% conv.
          </p>
        </div>
      </div>
...
export const InsightsCard: React.FC<InsightsCardProps> = ({
  ...
  return (
    <div
      className={cn(
        "bg-gradient-to-r from-amber-50 to-orange-50 rounded-lg border border-amber-100 p-4",
        className,
      )}
    >
