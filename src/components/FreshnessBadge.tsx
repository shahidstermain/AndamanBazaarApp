...
export const FreshnessBadge: React.FC<FreshnessBadgeProps> = ({
  ...
  if (availabilityStatus === "sold_recently") {
    return (
      <div
        className={`flex items-center gap-1 bg-orange-100 text-orange-700 rounded-full ${sizeClasses[size]}`}
      >
  ...
  if (availabilityStatus === "inactive") {
    return (
      <div
        className={`flex items-center gap-1 bg-gray-100 text-gray-600 rounded-full ${sizeClasses[size]}`}
      >
  ...
  return (
    <div
      className={`flex items-center gap-1 bg-green-100 text-green-700 rounded-full ${sizeClasses[size]}`}
    >
