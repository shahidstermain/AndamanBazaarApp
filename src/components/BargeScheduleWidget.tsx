...
export const BargeScheduleWidget: React.FC<BargeScheduleWidgetProps> = ({
  ...
  const [selectedDeparture, setSelectedDeparture] =
    useState<NextDeparture | null>(null);
  ...
  if (!loading && !route && !error) {
    return (
      <div
        className={cn(
          "bg-gray-50 rounded-lg p-3 text-sm text-gray-500",
          className,
        )}
      >
  ...
  const handleSuggestTime = (departure: NextDeparture) => {
    ...
    const suggestions = suggestPickupTimes(
      [departure],
      buyerLocation,
      sellerLocation,
    );
                  ...
                  onClick={(e) => {
                    ...
                    try {
                      ...
                      if (
                        ...
                        e.preventDefault();
                        console.warn(
                          "Blocked potentially unsafe URL:",
                          dep.booking_url,
                        );
                      }
                    } catch {
