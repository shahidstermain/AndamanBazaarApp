...
const LoadingFallback: React.FC<{ className?: string }> = ({
  className = "",
}) => (
...
const SpinnerFallback: React.FC<{ className?: string }> = ({
  className = "",
}) => (
...
export const IntersectionLazyRoute: React.FC<
  LazyRouteProps & {
    rootMargin?: string;
    threshold?: number;
  }
...
export const LazyHome = () => (
  <LazyRoute componentPath="Home" fallback={<LoadingFallback />} />
);
export const LazyListings = () => (
  <LazyRoute componentPath="Listings" fallback={<LoadingFallback />} />
);
export const LazyListingDetail = () => (
  <LazyRoute componentPath="ListingDetail" fallback={<LoadingFallback />} />
);
export const LazyCreateListing = () => (
  <LazyRoute componentPath="CreateListing" fallback={<LoadingFallback />} />
);
export const LazyProfile = () => (
  <LazyRoute componentPath="Profile" fallback={<LoadingFallback />} />
);
export const LazyChatList = () => (
  <LazyRoute componentPath="ChatList" fallback={<LoadingFallback />} />
);
export const LazyChatRoom = () => (
  <LazyRoute componentPath="ChatRoom" fallback={<LoadingFallback />} />
);
export const LazyAdmin = () => (
  <LazyRoute componentPath="Admin" fallback={<LoadingFallback />} />
);
export const LazyDashboard = () => (
  <LazyRoute componentPath="Dashboard" fallback={<LoadingFallback />} />
);
