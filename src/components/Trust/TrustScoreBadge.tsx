...
export const TrustScoreBadge: React.FC<TrustScoreBadgeProps> = ({ score, badge = 'Good', className = '' }) => {
  ...
  return (
    <div className={`flex items-center gap-1.5 px-2 py-1 rounded-lg text-[10px] font-black uppercase tracking-widest border ${config.style} ${className}`} title={config.label}>
      {config.icon}
